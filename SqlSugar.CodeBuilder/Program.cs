...
namespace SqlSugar.CodeBuilder
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                ConnectionString = "Server=localhost;Port=3306;Database=lkworkscloud;Uid=root;Pwd=123456;",
                DbType = DbType.MySql,
                ConfigId = 1,
            });
            ...
            foreach (var tableInfo in db.DbMaintenance.GetTableInfoList())
            {
                ...
                {
                    var propertyName = columnInfo.DbColumnName.ToPascalString();
            ...
            {
                return temp;
            }).CreateClassFile("./classes", "Evget.LKCloudServiceCore.Entities");
